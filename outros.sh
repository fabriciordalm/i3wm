...
sleep 2s;
sudo pacman -S yay thunar kate unzip pcmanfm picom lxappearance sqlite3 alacritty nitrogen discord flatpak spotify plank onlyoffice flameshot zscroll playerctl npm ttf-ms-fonts iriunwebcam-bin gtop ruby gksu nautilus
